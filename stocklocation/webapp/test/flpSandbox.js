		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#matixcomspstocklocationstocklocation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomspstocklocationstocklocation-display": {
								"semanticObject": "matixcomspstocklocationstocklocation",
								"action": "display",
								"description": "matix-Stock at Different Locations",
								"title": "Stock at Different Locations",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.sp.stocklocation.stocklocation",
									"url": sap.ui.require.toUrl("matix/com/sp/stocklocation/stocklocation")
								}
							}
						}
					}
