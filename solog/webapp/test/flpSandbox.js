		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SO Log",
									"targetURL": "#matixcomlogsologsolog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomlogsologsolog-display": {
								"semanticObject": "matixcomlogsologsolog",
								"action": "display",
								"description": "SO Log",
								"title": "SO Log",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.log.solog.solog",
									"url": sap.ui.require.toUrl("matix/com/log/solog/solog")
								}
							}
						}
					}
