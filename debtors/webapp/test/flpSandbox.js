		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#matixcomrepdebtorsdebtors-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomrepdebtorsdebtors-display": {
								"semanticObject": "matixcomrepdebtorsdebtors",
								"action": "display",
								"description": "Debtors: Outstanding with aging",
								"title": "Debtors: Outstanding with aging",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.rep.debtors.debtors",
									"url": sap.ui.require.toUrl("matix/com/rep/debtors/debtors")
								}
							}
						}
					}
