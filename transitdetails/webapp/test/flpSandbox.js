		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#matixcomreptransitdetailstransitdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomreptransitdetailstransitdetails-display": {
								"semanticObject": "matixcomreptransitdetailstransitdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.rep.transitdetails.transitdetails",
									"url": sap.ui.require.toUrl("matix/com/rep/transitdetails/transitdetails")
								}
							}
						}
					}
