		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SO Creation",
									"targetURL": "#matixcomspsocreationsocreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomspsocreationsocreation-display": {
								"semanticObject": "matixcomspsocreationsocreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.sp.socreation.socreation",
									"url": sap.ui.require.toUrl("matix/com/sp/socreation/socreation")
								}
							}
						}
					}
