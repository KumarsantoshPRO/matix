		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#matixcomlogozilogozilog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"matixcomlogozilogozilog-display": {
								"semanticObject": "matixcomlogozilogozilog",
								"action": "display",
								"description": "OBD, ZGE and Invoice Log",
								"title": "OBD, ZGE and Invoice Log",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=matix.com.log.ozilog.ozilog",
									"url": sap.ui.require.toUrl("matix/com/log/ozilog/ozilog")
								}
							}
						}
					}
